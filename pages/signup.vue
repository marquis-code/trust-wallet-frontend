<template>
  <main style="background-color: #fdf4ff" class="h-screen">
    <section class="">
      <div class="overflow-hidden flex justify-center md:space-x-20 items-center pt-6">
        <div class="w-11/12 md:w-10/12 mt-20">
          ...
          <div class="mx-auto max-w-xl text-center sm:text-left">
            <section
              v-if="currentStep === 1"
              action=""
              class="mt-6 space-y-9 rounded-md md:rounded-lg md:p-10 shadow-md md:ring-1 mb-10 md:ring-gray-100 py-10 md:bg-white"
            >
              ...
              <div class="flex justify-center items-center">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <div class="flex items-center space-x-3">
                    <div>
                      <input id="shopper" v-model="form.userType" value="shopper" type="radio" class="h-4 w-4">
                    </div>
                    <div>
                      <label for="shopper" class="font-medium  cursor-pointer md:text-base text-sm tracking-wide" style="color: #360040">
                        I am a shopper
                      </label>
                    </div>
                  </div>
                  <div class="flex items-center space-x-3">
                    <div>
                      <input id="freelancer" v-model="form.userType" value="freelancer" type="radio" class="h-4 w-4">
                    </div>
                    <div>
                      <label for="freelancer" class="font-medium  cursor-pointer md:text-base text-sm tracking-wide" style="color: #360040">
                        I am a freelancer
                      </label>
                    </div>
                  </div>
                  <div class="flex items-center space-x-3">
                    <div>
                      <input id="dropshipper" v-model="form.userType" value="dropshipper" type="radio" class="h-4 w-4">
                    </div>
                    <div>
                      <label for="dropshipper" class="font-medium  cursor-pointer md:text-base text-sm tracking-wide" style="color: #360040">
                        I am a dropshipper
                      </label>
                    </div>
                  </div>
                  <div class="flex items-center space-x-3">
                    <div>
                      <input id="merchant" v-model="form.userType" value="merchant" type="radio" class="h-4 w-4">
                    </div>
                    <div>
                      <label for="merchant" class="font-medium cursor-pointer md:text-base text-sm tracking-wide" style="color: #360040">
                        I am a merchant
                      </label>
                    </div>
                  </div>
              ...
              <button
                ...
                class="block w-10/12 mx-auto rounded-lg px-5 py-3 md:py-3 text-xs md:text-base font-medium text-white"
                @click="next"
              >
                Continue
              </button>
              ...
              <p class="text-center text-sm text-gray-500 mt-3">
                ...
                <nuxt-link style="color: #8b4e96" class="font-medium" to="/login">
                  Login
                </nuxt-link>
              </p>
            </section>
            ...
            <section
              v-if="currentStep === 2"
              action=""
              class="mt-6 space-y-9 rounded-md md:rounded-lg md:p-10 shadow-md md:ring-1 mb-10 md:ring-gray-100 px-3 py-10 md:bg-white"
            >
              <div class="flex justify-center items-center flex-col space-y-2">
                <!-- <img src="@/assets/img/trustXLogo.svg" alt="" /> -->
                <p class="text-center md:text-lg font-semibold" style="color: #360040">
              ...
              <div>
                ...
                <div class="relative">
                  <input
                    v-model="form.phone"
                    type="tel"
                    class="w-full text-lg rounded-lg border py-2.5 md:text-base pl-36 pr-6 outline-none border-none ring-1 ring-gray-300"
                    placeholder="903 3467 368"
                  >
                  <img src="@/assets/img/phoneFlag.svg" alt="" class="absolute h-6 top-3 pl-4">
                  <img src="@/assets/img/bisect.svg" alt="" class="absolute  top-0 pl-32">
                </div>
              </div>
              ...
              <div>
                ...
                <div class="relative">
                  <input
                    v-model="form.email"
                    type="email"
                    class="w-full rounded-lg py-2.5 p-3 pr-6 text-xs md:text-base outline-none border-none ring-1 ring-gray-300"
              ...
              <div>
                ...
                <div class="relative">
                  <input
                    ...
                    class="w-full rounded-lg px-4 py-3 border pr-12 text-sm text-xs md:text-base outline-none border-none ring-1 ring-gray-300"
            ...
            >
              <div class="flex justify-center items-center flex-col space-y-2">
                <img src="@/assets/img/trustXLogo.svg" alt="">
                <p class="text-center text-lg font-semibold" style="color: #360040">
                  Let’s verify your identity
                </p>
                <p style="color: #360040" class="text-sm md:text-base">
