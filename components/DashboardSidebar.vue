          ...
          <template #default="{ hide }">
            ...
            <nav aria-label="Main Nav" class="mt-6 flex flex-col space-y-9 w-10/12 mx-auto pb-6">
              <div class="space-y-6">
                ...
                <div @click="redirectToTelegram" class="flex items-center space-x-5">
                  <div class="p-2.5 rounded-full" style="background-color: #e7caec">
                ...
                <nuxt-link to="/dashboard/settings/profile" class="flex items-center space-x-5">
                  <div class="p-2.5 rounded-full" style="background-color: #e7caec">
              ...
              <div class="flex justify-center items-center">
                <button @click="logout" class="text-white font-medium py-2.5 text-center rounded-md w-full"
